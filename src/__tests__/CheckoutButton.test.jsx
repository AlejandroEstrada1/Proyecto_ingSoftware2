...
describe("CheckoutButton", () => {
  ...
  it("usa el texto por defecto cuando no recibe children", () => {
    render(<CheckoutButton onClick={jest.fn()} />)

    expect(screen.getByTestId("checkout-btn")).toHaveTextContent("Simular pago")
  })
